        ...
        <div class="mx-auto mt-12">
            ...
            <form method="post" enctype="multipart/form-data" action="services/change-password.php" class="w-[400px] flex flex-col gap-3 mt-5 border border-1 p-5 shadow-xl shadow-orange-300/80 border-black rounded-xl">
                ...
                <div class="w-full">
                    ...
                    <input type="text" placeholder="Masukkan NIP" value="<?= ucfirst($userLogin['nip']) ?>" name="nip" class="w-full bg-white border input input-sm text-slate-900 border-black/50 input-bordered" autofocus required />
                </div>
                <div class="w-full">
                    <label class="w-16 label">
